...
<div class="side-by-side">
  <figure>
    <img src="/img/posts/reverse-engineering-monitor/osd_kvm.webp" alt="The OSD KVM menu" />
    <figcaption>The OSD KVM menu</figcaption>
  </figure>
  <figure>
    <img src="/img/posts/reverse-engineering-monitor/osd_input.webp" alt="The OSD Input Source menu" />
    <figcaption>The OSD Input Source menu</figcaption>
  </figure>
</div>
